...
/// still need to invoke [`enable_multi_table_joins!`] for these two tables to
...
/// enable_multi_table_joins!(posts, users);
///
/// # fn main() {
...
/// enable_multi_table_joins!(comments, posts, users);
/// ```
///
...
///
/// ```ignore
/// enable_multi_table_joins!(comments, posts);
/// enable_multi_table_joins!(comments, users);
/// enable_multi_table_joins!(posts, users);
/// ```
#[macro_export]
macro_rules! enable_multi_table_joins {
    ($left_mod:ident, $($right_mod:ident),+ $(,)*) => {
        ...
        enable_multi_table_joins!($($right_mod,)+);
    };
